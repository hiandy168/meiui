...
CREATE TABLE `meiui_app` (
  ...
  `app_name` varchar(50) NOT NULL COMMENT 'APP??',
  `app_sys` tinyint(1) unsigned NOT NULL DEFAULT '2' COMMENT '????(1:android, 2:ios)',
  `description` varchar(250) NOT NULL DEFAULT '' COMMENT '??',
  `create_user` varchar(32) NOT NULL COMMENT '???',
  `create_time` int(11) NOT NULL COMMENT '????',
  `using_flag` tinyint(2) unsigned NOT NULL DEFAULT '3' COMMENT '??1 ??  2 ?? 3 ?????',
  PRIMARY KEY (`id`)
...
CREATE TABLE `meiui_classification` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '????',
  `parentid` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT '????? ???????? ??0 ',
  `arrparentid` varchar(255) NOT NULL DEFAULT '0' COMMENT '?????????????? 0,1,2',
  `child` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '??????? ?1 ??0',
  `arrchildid` varchar(255) NOT NULL DEFAULT '0' COMMENT '????????????? 0,1,2',
  `catname` varchar(30) NOT NULL COMMENT '????',
  `image_count` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '??????',
  `user_count` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '???????',
  `using_flag` int(10) unsigned NOT NULL DEFAULT '1' COMMENT '?? 1?? 2??',
  PRIMARY KEY (`id`)
...
CREATE TABLE `meiui_feedback` (
  ...
  `phone` int(18) NOT NULL COMMENT '???',
  `email` varchar(70) NOT NULL DEFAULT '' COMMENT '??',
  `pic_arr` varchar(255) NOT NULL DEFAULT '' COMMENT '??',
  `created_at` int(10) unsigned NOT NULL COMMENT '???',
  `msg_flag` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '1??? 2???',
...
CREATE TABLE `meiui_pic` (
  ...
  `app_name` varchar(50) NOT NULL DEFAULT '' COMMENT 'APP??',
  `pic_sys` tinyint(1) NOT NULL DEFAULT '2' COMMENT '????(1:android, 2:ios)',
  `pic_url` varchar(250) NOT NULL DEFAULT '' COMMENT '??URL ??',
  `pic_w` int(6) NOT NULL DEFAULT '0' COMMENT '???',
  `pic_h` int(6) NOT NULL DEFAULT '0' COMMENT '???',
  `brief` mediumtext NOT NULL COMMENT '??',
  `create_user` int(10) NOT NULL COMMENT '???id',
  `create_time` int(11) NOT NULL COMMENT '????',
  `using_flag` int(2) unsigned NOT NULL DEFAULT '1' COMMENT '??1 ?????  2 ?? 3 ??',
  PRIMARY KEY (`id`),
  KEY `app_id` (`app_id`),
...
CREATE TABLE `meiui_pic_link_tag` (
  ...
  `pic_id` int(10) NOT NULL COMMENT '??id',
  `tag_id` int(10) NOT NULL COMMENT '????ID',
  `tag_type` tinyint(1) NOT NULL DEFAULT '2' COMMENT '???? 1 ??  2 ??',
...
CREATE TABLE `meiui_search` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '????',
  `keyword` varchar(150) NOT NULL COMMENT '???',
  `image_count` varchar(70) NOT NULL DEFAULT '0' COMMENT '??????',
  `del_flag` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '1??? 2??',
  PRIMARY KEY (`id`)
...
CREATE TABLE `meiui_tag` (
  ...
  `create_user` varchar(32) NOT NULL COMMENT '?????',
  `create_time` int(11) NOT NULL COMMENT '????',
  `tag_type` tinyint(2) unsigned NOT NULL DEFAULT '1' COMMENT '??1 ??  2 ??',
  `using_flag` tinyint(2) unsigned NOT NULL DEFAULT '1' COMMENT '??1 ??  2 ??',
  PRIMARY KEY (`id`)
...
CREATE TABLE `meiui_user` (
  ...
  `user_pic` varchar(255) NOT NULL DEFAULT '' COMMENT '????',
  `password` char(40) NOT NULL COMMENT '??',
  `phone` varchar(18) NOT NULL DEFAULT '' COMMENT '???',
  `email` varchar(70) NOT NULL COMMENT '??',
  `created_at` int(10) unsigned NOT NULL COMMENT '???',
  `source` tinyint(1) NOT NULL DEFAULT '1' COMMENT '???? 1?? 2???? 3????',
  `del_flag` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '1?? 2???',
  PRIMARY KEY (`id`),
...
CREATE TABLE `meiui_users` (
  ...
  `created_at` int(10) unsigned NOT NULL COMMENT '???',
  `del_flag` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '1?? 2???',
  `group` tinyint(1) NOT NULL DEFAULT '1' COMMENT '???????1?????2',
  `source` tinyint(1) NOT NULL DEFAULT '2' COMMENT '???? 1?? 2????',
  `user_pic` varchar(255) NOT NULL DEFAULT '' COMMENT '????',
  PRIMARY KEY (`id`)
...
CREATE TABLE `meiui_user_data` (
  ...
  `user_collection_count` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '??????',
  `user_classification_count` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '????????',
  `user_upload_count` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '??????',
  PRIMARY KEY (`id`)
...
CREATE TABLE `meiui_user_link_classification` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '????',
  `user_id` int(10) unsigned NOT NULL COMMENT '??ID',
  `user_classification` int(10) unsigned NOT NULL COMMENT '??????',
  PRIMARY KEY (`id`)
...
CREATE TABLE `meiui_user_link_collection` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '????',
  `user_id` int(10) unsigned NOT NULL COMMENT '??ID',
  `user_collection` int(10) unsigned NOT NULL COMMENT '????ID',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `meiui_user_link_tag` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '????',
  `user_id` int(10) unsigned NOT NULL COMMENT '??ID',
  `user_tag` int(10) unsigned NOT NULL COMMENT '??????',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
