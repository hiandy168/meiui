...
<body>
	<div class="header">
		<img class="logo" src="/img/icon.png" alt="" width="150" height="150">
		<span class="title"><img src="http://www.meiui.me/img/title.png" width="196" height="95" alt=""></span>
	</div>
