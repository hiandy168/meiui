...
<div align="center">
    ...
    <table class="table table-bordered table-striped" align="center">
        ...
        <tr>
            ...
            <td width="7%">{{ link_to("pic/edit_user_pic/?pic_flag=2&id=" ~ pic.id, ''~ '录入系统', "class": "btn btn-default") }}{{ link_to("pic/edit_user_pic/?id=" ~ pic.id, ''~ '修改内容', "class": "btn btn-default") }}</td>
        </tr>
        </tbody>
